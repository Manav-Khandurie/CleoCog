...
const initialChatState: Chat[] = getSafeSavedChats() || [
    {
        ...
        content: [
            ...
            {
                emitter: "gpt",
                message: "Welcome to CleoClog.com! This is a website that allows you to chat with an AI model. You can ask questions, get information, and have conversations with the AI. It's a fun and interactive way to explore the capabilities of AI technology. If you have any specific questions or topics you'd like to discuss, feel free to ask!"
            }
        ],
    },
    {
